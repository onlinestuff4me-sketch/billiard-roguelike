...
<span class="kicker">Option C &middot; recommended</span>
...
<div class="row" style="margin-top:2px;">
  ...
  <p class="lede" style="flex:1"><b style="color:{BAD}">Against.</b> One line is a hard budget; a board that needs two sentences cannot have them, and the endpoint tags have to carry the rest. The band costs a fixed 44px whether or not the lesson needs it.</p>
</div>
</div>'''
